          ...
          <div className={`${styles.projectInfoCon}`}>
            <div className={`${styles.projectInfoTxt}`}>
              ...
              <div className={`${styles.info}`}>
                ...
                user가 자주 찾는 정보이지만 쉽게 찾기 불편한 콘텐츠는 별도의
                배너를 제작하여 편의성을 증대하였습니다.
                <p>
                  이를 통해 사용자들은 원하는 정보를 쉽게 찾게 될 것이고,
                  유용성과 사용성을 모두 충족한 k-mooc 사이트를 더 많은
                  사용자들이 이용하게 될 것이라 기대합니다.
                </p>
              </div>
            </div>
            <div className={`${styles.projectInfoBox}`}>
              ...
              <ol className={`${styles.functionListCon}`}>
                ...
                <li>
                  JSON 형식의 객체 배열 - map 메소드 활용한 데이터 가져오기
                </li>
